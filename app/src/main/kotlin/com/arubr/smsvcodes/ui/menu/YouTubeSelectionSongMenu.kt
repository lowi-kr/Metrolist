            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.arubr.smsvcodes.db.entities.Song(
                            song =
                                com.arubr.smsvcodes.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.arubr.smsvcodes.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.arubr.smsvcodes.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
