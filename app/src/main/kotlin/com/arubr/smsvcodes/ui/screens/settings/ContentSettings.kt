...
import com.arubr.smsvcodes.constants.ContentCountryKey
import com.arubr.smsvcodes.constants.ContentLanguageKey
import com.arubr.smsvcodes.constants.CountryCodeToName
import com.arubr.smsvcodes.constants.EnableBetterLyricsKey
import com.arubr.smsvcodes.constants.EnableKugouKey
import com.arubr.smsvcodes.constants.EnableLrcLibKey
import com.arubr.smsvcodes.constants.EnablePaxsenixKey
import com.arubr.smsvcodes.constants.EnableLyricsPlus
import com.arubr.smsvcodes.constants.HideExplicitKey
import com.arubr.smsvcodes.constants.HideVideoSongsKey
import com.arubr.smsvcodes.constants.HideYoutubeShortsKey
import com.arubr.smsvcodes.constants.LanguageCodeToName
import com.arubr.smsvcodes.constants.LyricsProviderOrderKey
import com.arubr.smsvcodes.constants.ProxyEnabledKey
import com.arubr.smsvcodes.constants.ProxyPasswordKey
import com.arubr.smsvcodes.constants.ProxyTypeKey
import com.arubr.smsvcodes.constants.ProxyUrlKey
import com.arubr.smsvcodes.constants.ProxyUsernameKey
import com.arubr.smsvcodes.constants.QuickPicks
import com.arubr.smsvcodes.constants.QuickPicksKey
import com.arubr.smsvcodes.constants.RandomizeHomeOrderKey
import com.arubr.smsvcodes.constants.SYSTEM_DEFAULT
import com.arubr.smsvcodes.constants.ShowArtistDescriptionKey
import com.arubr.smsvcodes.constants.ShowMostStatsPlaylistsKey
import com.arubr.smsvcodes.constants.ShowArtistSubscriberCountKey
import com.arubr.smsvcodes.constants.ShowMonthlyListenersKey
import com.arubr.smsvcodes.constants.ShowWrappedCardKey
import com.arubr.smsvcodes.constants.TopSize
...
import com.arubr.smsvcodes.ui.component.DraggableLyricsProviderItem
import com.arubr.smsvcodes.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.arubr.smsvcodes.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.arubr.smsvcodes.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.arubr.smsvcodes.db.entities.PlaylistEntity(
                        id = com.arubr.smsvcodes.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.arubr.smsvcodes.db.entities.PlaylistEntity(
                        id = com.arubr.smsvcodes.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
