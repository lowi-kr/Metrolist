...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.arubr.smsvcodes.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.arubr.smsvcodes.widget.LIKE"
        const val ACTION_NEXT = "com.arubr.smsvcodes.widget.NEXT"
        const val ACTION_PREVIOUS = "com.arubr.smsvcodes.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.arubr.smsvcodes.widget.UPDATE_WIDGET"
    }
}
