...
package com.arubr.smsvcodes.listentogether
...
import com.arubr.smsvcodes.constants.ListenTogetherAutoApprovalKey
import com.arubr.smsvcodes.constants.ListenTogetherAutoApproveSuggestionsKey
import com.arubr.smsvcodes.constants.ListenTogetherIsHostKey
import com.arubr.smsvcodes.constants.ListenTogetherRoomCodeKey
import com.arubr.smsvcodes.constants.ListenTogetherServerUrlKey
import com.arubr.smsvcodes.constants.ListenTogetherSessionTimestampKey
import com.arubr.smsvcodes.constants.ListenTogetherSessionTokenKey
import com.arubr.smsvcodes.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.arubr.smsvcodes.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.arubr.smsvcodes.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.arubr.smsvcodes.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.arubr.smsvcodes.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.arubr.smsvcodes.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.arubr.smsvcodes.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
